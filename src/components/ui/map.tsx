...
function MapTileLayer({
  ...
  const DEFAULT_URL = `https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}.png?key=${process.env.NEXT_PUBLIC_MAPKEY}`;
  const DEFAULT_DARK_URL = `https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}.png?key=${process.env.NEXT_PUBLIC_MAPKEY}`;
